...
{/* 
          <Link to={"/user_manage_lorawan_gateway"}>
            <Box>
          ...
          <Link to={"/user_dashboard_customization"}>
          <Box>
          ...
          <Link to={"/user_manage_subscription"}>
         <Box>
